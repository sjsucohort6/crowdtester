...
<form action="/crowdtester/register" method="post">
    <dl>
        <dt>First Name:
        <dd><input type="text" name="username" maxlength="50" size="30" value="${firstName!}">
        <dt>Last Name:
        <dd><input type="text" name="username" maxlength="50" size="30" value="${secondName!}">
        <dt>User Name:
